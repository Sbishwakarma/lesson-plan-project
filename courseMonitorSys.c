...
// 	printf("\nEnter Course ID: ");
// 	takeInput(newCourse.id);
// 	printf("Enter Course Name: ");
// 	takeInput(newCourse.name);
// 	printf("Enter Teacher Username: ");
// 	takeInput(newCourse.teacher);
// 	printf("Enter List of Lessons (comma-separated): ");
// 	takeInput(newCourse.lessons);

// 	// Split lessons and initialize coverages
// 	char *lesson = strtok(newCourse.lessons, ",");
...
// 		{
// 			printf("\nCurrent Coverage: %.2f%%\n", crs.totalCoverage);
// 			printf("Enter New Coverage Percentage: ");
// 			scanf("%f", &crs.totalCoverage);
